...
def parse_arguments():
    ...
    parser.add_argument(
        "manifest_file", type=str, help="Path to the manifest csv file."
    )
    parser.add_argument(
        "model_folder", type=str, help="Folder containing the MICOM community model."
    )
    parser.add_argument("medium_file", type=str, help="Path to the medium file.")
    parser.add_argument(
        "--tradeoff",
        type=float,
        default=0.5,
